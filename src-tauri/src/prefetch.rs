...
pub fn filetime_to_rfc3339(filetime: u64) -> Option<String> {
    ...
    // Sanity bounds check: filetime must be between Jan 1, 1980 and Dec 31, 2099 to avoid false-positive binary matches
    if filetime < 119600064000000000 || filetime > 160000000000000000 {
        return None;
    }
