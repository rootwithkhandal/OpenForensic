...
mod tests {
    ...
    fn test_seal_keygen_and_inspect() {
        ...
        assert!(priv_pem.contains("-----BEGIN OPENFORENSIC ED25519 PRIVATE KEY-----"));
        assert!(pub_pem.contains("-----BEGIN OPENFORENSIC ED25519 PUBLIC KEY-----"));
        ...
        assert_eq!(inspect_info.public_key_b64, info.public_key_b64);
    ...
    fn test_detached_signing_and_verification() {
        ...
        assert!(sig_pem.contains("-----BEGIN OPENFORENSIC ED25519 SIGNATURE-----"));
    ...
    fn test_tampered_evidence_fails_verification() {
        ...
        let tampered_sig = sig_pem.replace("Signature: ", "Signature: 0000000000000000");
